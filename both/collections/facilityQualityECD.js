...
'office.facSickBaySeparate':              {label: "Is there a dedicated space used only for a sickbay?", 
      type: String, allowedValues: ['Yes', 'No'] },
'office.facSickbayOfficeShared':          {label: "Is the sickbay part of the office?", 
      type: String, allowedValues: ['Yes', 'No'] },
'office.facOfficeSpace':                  {label: "Is there a dedicated space used only for office/administration work", 
      type: String, allowedValues: ['Yes', 'No'] },
'office.facOfficeSeparate':               {label: "Is the office space a separate room", 
      type: String, allowedValues: ['Yes', 'No'] },
'office.facOfficeSize':                   {label: "Office size (sqm)", 
      type: Number },
///////////////////
power: {
    type: Object
...
'outdoors.facOutdoorEquipIssues':           {label: "Visible issues with outdoor equipment", 
      type: String },
'outdoors.facSitePerimeterEnclosed':        {label: "Site Perimeter enclosed", 
      type: String, allowedValues: ['Wall', 'Fence', 'Hedge', 'Nothing', 'Other'] },
///////////////////
outdoorsEquipment: {
    type: Object
  },
'outdoorsEquipment.facGate':                         {label: "Lockable, child-proof Gate", 
      type: String, allowedValues: ['Yes', 'No'] },
